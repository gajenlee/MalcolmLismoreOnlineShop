...
<body class="theme-set disable-scroll">
    ...
    setcookie(
        ...
        [
            ...
            'samesite' => 'Strict' // Strict mode prevents the cookie from being sent in cross-site requests
        ]
    );
    ...
    <section class="map">
        <iframe style="width: 100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d548508.1474081916!2d-7.539875293131379!3d57.51903205622101!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x488e9ff9bfffffff%3A0x458b69ebcf575b20!2sScottish%20West%20Coast%20Langoustine!5e0!3m2!1sen!2slk!4v1716887559911!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </section>

    <section class="contact-info container">
        <div class="contact-icons">
            <div class="cont address-info">
                <i class="fa fa-map-pin" aria-hidden="true"></i>
                <h3>
                    <span>Address</span>
                    <span>
                        <address>North West coast of Scotland</address>
                    </span>
                </h3>
            </div>
            <div class="cont email-info">
                <i class="fa fa-envelope" aria-hidden="true"></i>
                <h3>
                    <span>Email</span><br>
                    <span>service@malcolmlismore.com</span>
                </h3>
            </div>
            <div class="cont phone-info">
        ...
        <div class="contact-form">
            <form>
                ...
                <!-- Message input -->
                <div data-mdb-input-init class="form-outline mb-4">
                    <textarea class="form-control" name="msg" id="userMsg" rows="4"></textarea>
                    <label class="form-label" for="userMsg">Message</label>
                </div>

                <!-- Checkbox -->
                <div class="form-check d-flex justify-content-center mb-4">
                    <input class="form-check-input me-2" name="sendtome" type="checkbox" value="" id="sendToMe" checked />
                ...
                <!-- Submit button -->
                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-block mb-4" style="background-color: var(--global-color); color: #fff;">send</button>
            </form>
        </div>
    </section>
