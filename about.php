...
<head>
    ...
    <title>Malcolm Lismore | About</title>
...
<body class="theme-set disable-scroll">
    ...
    <header>
        ...
        <div class="hero-intro container content">
            <div class="hero-title " style="margin-top: 100px;">
                <h1>
                    <span> I'm </span>
                ...
                <div class="text" style="margin-top: 20px;">
                    <p>
                        Welcome to Malcolm Lismore Photography, where passion meets professionalism on the North West coast of Scotland.
                        Our website is designed to offer you an immersive experience into the stunning world of Scottish landscapes,
                        wildlife, and special event photography.
                    </p>

                    <h4>Photography Portfolio</h4>

                    <p>
                        Dive into our carefully curated portfolio, showcasing the raw beauty of Scotland's rugged landscapes,
                        its diverse wildlife, and vibrant coastal birds. Each photograph in our gallery is a testament to Malcolm
                        Lismore's expertise and eye for detail, capturing moments that tell the unique stories of nature. Whether you are
                        looking to bring the splendor of Scotland into your home or seeking inspiration for your own photography, our portfolio is
                        designed to captivate and inspire.
                    </p>

                    <h4>Booking Enquiry System</h4>

                    <p>
                        Planning a wedding, special event, or personal portrait session? Our intuitive booking enquiry system makes
                        it easy for you to connect with us. Simply fill out the enquiry form with your details, and we'll get back to you promptly
                        to discuss your needs and schedule your session. We are committed to providing personalized service, ensuring every moment is captured
                        perfectly and tailored to your vision.
                    </p>


                    <p>
                        At Malcolm Lismore Photography, we believe in creating timeless memories through our lens. Explore our website,
                        discover our work, and let us help you preserve your most cherished moments. Thank you for visiting, and we look
