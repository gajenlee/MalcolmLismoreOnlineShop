...
else if (empty($_SESSION['user_id'])) echo "<script> window.location.href='./login_sys/login.php'; </script>";
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <h5 class="my-3"><?php echo $_SESSION["user_fname"] . " " . $_SESSION["user_lname"] ?></h5>
                            <p class="text-muted mb-1">Subscriber</p>
                            <p class="text-muted mb-4"><?php echo $_SESSION["user_address"]; ?></p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo $_SESSION["user_fname"] . " " . $_SESSION["user_lname"]; ?></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo $_SESSION["user_mobile"]; ?></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><?php echo $_SESSION["user_address"]; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
