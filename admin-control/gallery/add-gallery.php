...
<body class="theme-set disable-scroll">
        ...
        <div class="p-5 bg-body-tertiary mb-4" style="background-color: transparent !important;">
            ...
            <nav class="d-flex">
                <h6 class="mb-0">
                    ...
                    <span>/</span>
                    <a href="./add-gallery.php" class="text-reset"><u>Gallery</u></a>
                </h6>
            </nav>
        </div>
    </header>

    <section class="form-add add-gallery">
        <div class="container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="myForm">
                <div class="form-outline" data-mdb-input-init>
                    <input name="galleryId" style="background-color: transparent;" class="form-control" id="formControlReadonly" type="text" value="<?php echo uniqid(); ?>" aria-label="readonly input example" readonly />
                    <label class="form-label" for="formControlReadonly">Gallery ID</label>
                </div>
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" name="galleryName" id="galleryName" class="form-control" data-mdb-showcounter="true" maxlength="50" />
                    <label class="form-label" for="galleryName">Gallery Name</label>
                ...
                <div class="form-outline control-btns">
                    <button type="submit" class="btn text-white" style="background-color: #ff4500;" role="button">
                        <i class="fa fa-plus" aria-hidden="true"></i>
                        add new gallery
                    </button>
                    <a class="btn text-white" data-mdb-ripple-init style="background-color: #ff4500;" href="./show-gallery.php" role="button">
                        Show Gallery Table
                    </a>
                </div>
            </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == 'POST') {
        ...
        if (!empty($_POST['galleryName'])) {
            ...
            $galleryName = validate_inputs($_POST['galleryName']);

            $gallery_insert_query = "INSERT INTO gallery ( gallery_id, gallery_name) VALUES ('$galleryId', '$galleryName')";

            if ($conn->query($gallery_insert_query) == true) echo "<script>show_alert('success-msg');</script>";
