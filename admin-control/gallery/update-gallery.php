...
<body class="theme-set disable-scroll">
        ...
        <div class="p-5 bg-body-tertiary mb-4" style="background-color: transparent !important;">
            ...
            <nav class="d-flex">
                <h6 class="mb-0">
                    ...
                    <span>/</span>
                    <a href="./update-gallery.php" class="text-reset"><u>Gallery</u></a>
                </h6>
            </nav>
        </div>
    ...
    $gallery_id = $_GET['id'];
    $gallery_select_query = "SELECT * FROM gallery WHERE gallery_id='$gallery_id'";

    $reslut = mysqli_query($conn, $gallery_select_query);
        ...
        <div class="container">
            <form action="" method="post" class="myForm">
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" name="galleryName" value="<?php echo $row['gallery_name']; ?>" id="galleryName" class="form-control" data-mdb-showcounter="true" maxlength="50" />
                ...
                <div class="form-outline control-btns">
                    <button name="submit" type="submit" class="btn text-white" style="background-color: #ff4500;" role="button">
                        update
                    </button>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['galleryName'])) {
            $gallery_name = validate_inputs($_POST['galleryName']);
            $gallery_update_query = "UPDATE gallery SET gallery_name='$gallery_name' WHERE gallery_id='$gallery_id'";

            if ($conn->query($gallery_update_query) == true) echo "<script> window.location.href='./show-gallery.php'; </script>";
