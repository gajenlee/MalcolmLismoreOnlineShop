        ...
        <div class="p-5 bg-body-tertiary mb-4" style="background-color: transparent !important;">
            ...
            <nav class="d-flex">
                <h6 class="mb-0">
                    ...
                    <span>/</span>
                    <a href="./shop-shop.php" class="text-reset"><u>Shop</u></a>
                </h6>
            </nav>
        </div>
    ...
    <section class="form-table shop-control">
        <div class="container">
            <table class="table table-striped mb-0  table-show">
                ...
                <tbody>
                    <?php
                    $image_select_query = "SELECT * FROM items INNER JOIN images ON items.item_image_id = images.image_id INNER JOIN gallery ON images.image_gallery_id = gallery.gallery_id;";
                    $result = mysqli_query($conn, $image_select_query);
                    while ($rows = mysqli_fetch_assoc($result)) {
                    ?>
                        <div class="modal fade" id="Modal_<?php echo $rows['item_id']; ?>" tabindex="-1" aria-labelledby="ModalLabel_<?php echo $rows['item_id']; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="ModalLabel_<?php echo $rows['item_id']; ?>"><?php echo "Item " . $rows['item_name']; ?></h5>
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn" style="background-color: #ffe1d6; color: #ff4500;" href="./delete-shop.php?id=<?php echo $rows['item_id']; ?>">Yes</a>
                        ...
                        <tr>
                            <th><?php echo $rows['item_id']; ?></th>
                            <th><?php echo $rows['item_name']; ?></th>
                            <th><?php echo $rows['item_price']; ?></th>
                            <th><?php echo $rows['item_description']; ?></th>
                            <th><?php echo $rows['image_name']; ?></th>
                            <th><?php echo $rows['gallery_name']; ?></th>
                            <th class="text-center">
                                <a href="update-shop.php?id=<?php echo $rows["item_id"] ?>" class="link-color">EDIT</a> <span style="font-size: 1.5rem; margin: 0 10px;">||</span>
                                <a data-mdb-button-init data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#Modal_<?php echo $rows['item_id']; ?>" class="link-color">DELETE</a>
                            </th>
                        </tr>
