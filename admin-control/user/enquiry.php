        ...
        <div class="p-5 bg-body-tertiary mb-4" style="background-color: transparent !important;">
            ...
            <nav class="d-flex">
                <h6 class="mb-0">
                    ...
                    <span>/</span>
                    <a href="../../enquery.php" class="text-reset"><u>Events</u></a>
                </h6>
            </nav>
        </div>
    </header>
    ...
    <section class="form-table shop-control">
        <div class="container">
            <table class="table table-striped mb-0 table-show">
                ...
                <tbody>
                    <?php
                    $select_query = "SELECT * FROM enquiry INNER JOIN users ON enquiry.customer_id = users.user_id";
                    $result = mysqli_query($conn, $select_query);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <div class="modal fade" id="Modal_<?php echo $row['enquiry_id']; ?>" tabindex="-1" aria-labelledby="ModalLabel_<?php echo $row['enquiry_id']; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="ModalLabel_<?php echo $row['enquiry_id']; ?>"><?php  echo "Enquiry"?></h5>
                                        <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn-close" data-mdb-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <h6>Is this event expired?</h6>
                                    </div>
                                    <div class="modal-footer">
                                        <a class="btn" style="background-color: #ffe1d6; color: #ff4500;" href="./remove-enquiry.php?id=<?php echo $row['enquiry_id']; ?>">Yes</a>
                        ...
                        <tr>
                            <th><?php echo $row['enquiry_id']; ?></th>
                            <th><?php echo $row['fname'] . " " . $row['lname']; ?></th>
                            <th><?php echo $row['phone']; ?></th>
                            <th><?php echo $row['email']; ?></th>
                            <th><?php echo $row['event_type']; ?></th>
                            <th><?php echo $row['event_date']; ?></th>
                            <th><?php echo $row['event_time']; ?></th>
                            <th><?php echo $row['event_location']; ?></th>
                            <th><?php echo $row['message']; ?></th>
                            <th class="d-flex flex-row align-items-center justify-content-center text-center">
                                <a data-mdb-button-init data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#Modal_<?php echo $row['enquiry_id']; ?>" class="link-color">EXPIRED</a>
                            </th>
                        </tr>
