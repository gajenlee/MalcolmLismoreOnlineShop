        ...
        <div class="p-5 bg-body-tertiary mb-4" style="background-color: transparent !important;">
            ...
            <nav class="d-flex">
                <h6 class="mb-0">
                    ...
                    <span>/</span>
                    <a href="./show-image.php" class="text-reset"><u>Image</u></a>
                </h6>
            </nav>
        </div>
    ...
    <section class="form-table shop-control">
        <div class="container">
            <table class="table table-striped mb-0 table-show">
                ...
                <tbody>
                    <?php
                    $image_select_query = "SELECT image_id, image_name, image_path, image_description, gallery_name FROM images INNER JOIN gallery ON images.image_gallery_id = gallery.gallery_id";
                    $result = mysqli_query($conn, $image_select_query);
                    while ($rows = mysqli_fetch_assoc($result)) {
                    ?>

                        <div class="modal fade" id="Modal_<?php echo $rows['image_id']; ?>" tabindex="-1" aria-labelledby="ModalLabel_<?php echo $rows['image_id']; ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="ModalLabel_<?php echo $rows['image_id']; ?>"><?php echo "Image " . $rows['image_name']; ?></h5>
                                        <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn-close" data-mdb-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <h6>Do you want delete this Image?</h6>
                                        <p>If yes, the entire image related item would be <strong>removed</strong>.</p>
                                    </div>
                                    <div class="modal-footer">
                                        <a class="btn" style="background-color: #ffe1d6; color: #ff4500;" href="./delete-image.php?id=<?php echo $rows['image_id']; ?>">Yes</a>
                        ...
                        <tr>
                            <th><?php echo $rows['image_id']; ?></th>
                            <th><?php echo $rows['image_name']; ?></th>
                            <th><?php echo $rows['image_path']; ?></th> 
                            <th><?php echo $rows['image_description']; ?></th>
                            <th><?php echo $rows['gallery_name']; ?></th>
                            <th class="text-center">
                                <a href="update-image.php?id=<?php echo $rows["image_id"] ?>" class="link-color">EDIT</a> <span style="font-size: 1.5rem; margin: 0 10px;">||</span>
                                <a data-mdb-button-init data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#Modal_<?php echo $rows['image_id']; ?>" class="link-color">DELETE</a>
                            </th>
                        </tr>
