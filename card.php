                        ...
                        <table class="table table-show">
                            ...
                            <tbody>
                                ...
                                <?php 
                                    ...
                                    $card_query = "SELECT * FROM card INNER JOIN items ON card.card_item_id = items.item_id INNER JOIN images ON images.image_id = items.item_image_id INNER JOIN gallery ON gallery.gallery_id = images.image_gallery_id";
                                    $result = $conn -> query($card_query);
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo ".".$rows["image_path"] ?>" class="img-fluid rounded-3" style="width: 120px;" alt="Book">
                                                <div class="flex-column ms-4">
                                                    <p class="mb-2"><?php echo $rows['item_name']; ?></p>
                                                    <p class="mb-0"><?php echo $rows['gallery_name']; ?></p>
                                                </div>
                                            </div>
                                        </th>
                                        <td class="align-middle" style="background-color: transparent;">
                                            <div class="d-flex flex-row">
                                                <button data-mdb-ripple-init disabled class="btn btn-link px-2" onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                                                    <i class="fas fa-minus"></i>
                                                </button>

                                                <input id="form1" min="0" name="quantity" value="1" type="number" disabled class="form-control form-control-sm" style="width: 50px;" />

                                                <button data-mdb-ripple-init disabled class="btn btn-link px-2" onclick="this.parentNode.querySelector('input[type=number]').stepUp()">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                        </td>
                                        <td class="align-middle" style="background-color: transparent;">
                                            <p class="mb-0" style="font-weight: 500;">$<?php echo $rows['item_price'] ?></p>
                                        </td>

                                        <td class="align-middle" style="background-color: transparent;">
                                            <a href="./card-delete.php?id=<?php echo $rows['card_id']; ?>" class="nav-link"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php 
                                $total_price += $rows['item_price'];
                            }?>            
                            </tbody>
                        </table>
                    </div>

                    <div class="card payment shadow-2-strong mb-5 mb-lg-0 bg-transparent" style="border-radius: 16px;">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-xl-6">
                                            <div data-mdb-input-init class="form-outline mb-4 mb-xl-5">
                                                <input type="text" id="typeName" class="form-control form-control-lg" siez="17" placeholder="R Gajendran" />
                                ...
                                <div class="col-lg-4 col-xl-3">
                                    ...
                                    <div class="d-flex justify-content-between" style="font-weight: 500;">
                                        ...
                                        <p class="mb-0">$<?php echo $shipping_fee ?></p>
                                    </div>

                                    <div class="d-flex justify-content-between" style="font-weight: 500;">
                                        <p class="mb-0">Tax</p>
                                        <p class="mb-0">$<?php echo $tax ?></p>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between mb-4" style="font-weight: 500;">
                                        ...
                                        <p class="mb-2">$<?php echo $total_price + $shipping_fee + $tax; ?></p>
                                    </div>

                                    <button type="button" style="background-color: #ff4500;" data-mdb-button-init data-mdb-ripple-init class="btn btn-block btn-lg text-white">
                                        <div class="d-flex justify-content-between">
                                            <span>Checkout</span>
                                            <span>$<?php echo $total_price + $shipping_fee + $tax; ?></span>
                                        </div>
                                    </button>
